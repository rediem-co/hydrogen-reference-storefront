...
export type VariantProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  variantId: StorefrontAPI.Scalars['ID']['input'];
}>;

export type VariantProductQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query VariantProduct(\n    $country: CountryCode\n    $language: LanguageCode\n    $variantId: ID!\n  ) @inContext(country: $country, language: $language) {\n    node(id: $variantId) {\n      ... on ProductVariant {\n        id\n        selectedOptions {\n          name\n          value\n        }\n        product {\n          handle\n        }\n      }\n    }\n  }\n': {
    return: VariantProductQuery;
    variables: VariantProductQueryVariables;
  };
}

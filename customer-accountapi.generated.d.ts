...
export type RediemCustomerQueryVariables = CustomerAccountAPI.Exact<{
  [key: string]: never;
}>;

export type RediemCustomerQuery = {
  customer: Pick<
    CustomerAccountAPI.Customer,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query RediemCustomer {\n    customer {\n      id\n      firstName\n      lastName\n      emailAddress {\n        emailAddress\n      }\n      phoneNumber {\n        phoneNumber\n      }\n      tags\n    }\n  }\n': {
    return: RediemCustomerQuery;
    variables: RediemCustomerQueryVariables;
  };
}
